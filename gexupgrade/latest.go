...
const CLEAR = `
DELETE FROM exs_withdraw;
DELETE FROM exs_user;
DELETE FROM exs_order_comm;
DELETE FROM exs_order;
DELETE FROM exs_kline;
DELETE FROM exs_holding;
DELETE FROM exs_balance_history;
DELETE FROM exs_balance;
`
