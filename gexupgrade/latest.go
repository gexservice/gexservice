...
DELETE FROM gex_message;
DELETE FROM gex_kline;
DELETE FROM gex_holding;
DELETE FROM gex_balance_record;
DELETE FROM gex_balance_history;
DELETE FROM gex_balance;
`
